...
swiftc -O main.swift ProbeRun.swift SingleFlight.swift ChromeTab.swift ActivitySession.swift SessionPopover.swift CallDetector.swift CountdownPanel.swift TrackPanel.swift IdleWatcher.swift -o "$APP"
